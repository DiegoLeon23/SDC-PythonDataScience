...
app.layout = dbc.Container(
    [
        html.H1("Modelo Predictivo de Diabetes"),
        html.Hr(),
        dbc.Row(
            [
...
def display_value(n_clicks,value_pre,value_glu,value_blood,value_skin,value_insul,value_bmi,value_db,
    ...
    if n_clicks!=0:
            ...
            #print(salida)
            #print(probabilidad)
            #print("La predicción fue de clase '"+salida+"' con una probabilidad de :"+str(probabilidad))
            
            return "La predicción fue de clase '"+salida+"' con una probabilidad de "+str(round(float(probabilidad2),2))
